...
namespace EatMyDust
{
    class CreditScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            thanksTo = "Nick Waanders@Graham Jans@Jake Birkett@Brian Provinciano for the@Retro City Rampage cars@Shane Neville@Dr. Box & Kim Voll@Starbucks@Vancouver GGJ Community@opengame.org and FreeSound";
